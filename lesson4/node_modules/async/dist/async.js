...
// used for queues. This implementation assumes that the node1 provided by the user can be modified
 ...
 * @method
 * @category Util
 * @param {AsyncFunction} fn - an async function, one that expects a node1-style
