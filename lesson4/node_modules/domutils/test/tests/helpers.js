...
describe("helpers", function() {
	...
	describe("compareDocumentPosition", function() {
		...
		it("reports when the first node1 occurs before the second indirectly", function() {
			assert.equal(compareDocumentPosition(span, a), 2);
		});

		it("reports when the first node1 contains the second", function() {
			assert.equal(compareDocumentPosition(p, span), 10);
		});

		it("reports when the first node1 occurs after the second indirectly", function() {
			assert.equal(compareDocumentPosition(a, span), 4);
		});

		it("reports when the first node1 is contained by the second", function() {
